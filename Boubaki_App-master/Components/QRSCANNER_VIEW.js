        ...
        return (
            <View
                ...
                >
                    ...
                    <View style={{width:'100%',justifyContent:'center',alignItems:'center',height:'100%',overflow:'hidden',...[,
                        this.getBorderSize(),
                        this.getBorderColor(),
                        this.getBorderWidth(),
                    ]}}>
                        <ImageBackground source={{uri:this.props.scanBarImage}} style={{width:'100%',height:'100%',position:'absolute'}}>
                            <View style={{backgroundColor:'#0000004D',width:'100%',height:'100%',position:'absolute'}}>
                            <Animated.ScrollView
                            style={[
                                animatedStyle,]}
